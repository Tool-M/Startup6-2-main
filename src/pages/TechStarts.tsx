  ...
  const startups = [
    {
      Icon: Rocket,
      title: "SpaceConnect",
      description: "A revolutionary satellite communication platform connecting remote areas with high-speed internet.",
    },
    {
      Icon: Code,
      title: "DevFlow",
      description: "An AI-powered development environment that accelerates coding workflows and team collaboration.",
    },
    {
      Icon: Lightbulb,
      title: "BrightEnergy",
      description: "A smart energy management system for homes and businesses, optimizing consumption patterns.",
    },
    {
      Icon: Zap,
      title: "QuickMed",
      description: "An on-demand healthcare platform connecting patients with medical professionals instantly.",
    },
    {
      Icon: Target,
      title: "GoalTracker Pro",
      description: "A comprehensive project management tool with advanced analytics and team performance insights.",
    },
    {
      Icon: Globe,
      title: "EcoWorld",
      description: "A sustainable marketplace platform for eco-friendly products and carbon-neutral delivery.",
    },
  ];
